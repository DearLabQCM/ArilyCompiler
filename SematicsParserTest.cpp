...
int main()
{
    vector<string>progs;
    progs.push_back("{ }");
    progs.push_back("int a = 1 ; int b = 2 ; real c = 3.0 ; { a = a + 1 ; b = b * a ; if ( a < b ) then c = a / 2 ; else c = c / 5 ; }");
    progs.push_back("int a = 10 ; int b = 25 ; real c = 2.1 ; { a = a + 1 ; c = c * a ; b = b * a ; if ( a == b ) then c = a / 3 ; else c = b / 5 ; }");
    progs.push_back(" { { { } } }");

    //Error
    progs.push_back(" int a = 1 ; int b = 2 ; real c = 3.0 ; {   ");
    progs.push_back("int a = 1 ; int b = 2.0 ; real c = 3.0 ; { a = a + 1 ; b = b * a ; if ( a < b ) then c = c / 2 ; c = c / 4 } ");
    progs.push_back("int a = 3 ; int b = 5.73 ; real c = 3.0 ; { a = a + 1 ; b = b + a ; if ( a < b ) then c = c / 0 ; else c = c / 4 ; }");
    string prog=progs[6];
    Analysis(prog);
}
